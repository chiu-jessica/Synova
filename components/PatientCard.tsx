...
export default function PatientCard({
  ...
  return (
    // The delete control sits alongside the Link rather than inside it — a
    // button nested in an anchor is invalid and swallows the click.
    <div className="relative group">
      <Link
        href={`/patients/${patient.id}/diagnosis`}
        className="block rounded-card bg-white p-4 border border-black/5 shadow-[0_1px_2px_rgba(28,28,28,0.05)] hover:shadow-[0_6px_16px_rgba(6,148,148,0.14)] hover:border-teal/40 hover:-translate-y-0.5 transition-all"
      >
